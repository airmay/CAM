...
namespace CAM.TechProcesses.Disk3D
{
    ...
    public class LongCleaningTechOperation : MillingTechOperation<Disk3DTechProcess>
    {
        ...
        public static void ConfigureParamsView(ParamsView view)
        {
            ...
            view.AddIndent();
            view.AddTextBox(nameof(StartPass), "Начало");
            view.AddTextBox(nameof(EndPass), "Конец");
            view.AddTextBox(nameof(StepY), "Шаг Y мин.");
            view.AddTextBox(nameof(YMax), "Шаг Y макс.");
        ...
        public override void BuildProcessing(MillingCommandGenerator generator)
        {
            ...
            passList.ForEach(p =>
            {
                ...
                if (TechProcess.MachineType == Machine.Donatoni) //Settongs.IsFrontPlaneZero
